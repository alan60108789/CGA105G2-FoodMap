...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="container p-4 mt-10" style="width: 800px;">
            <h1 class="text-center mb-3">修改餐點資訊</h1>
            <hr>
                ...
                <div>
                    <form METHOD="post" action="<%=request.getContextPath()%>/front-end/store/food_order/food_order.do"
                        ...
                        <div class="form-group row">
                            <label for="mealId" class="fs-6 font-weight-bold">餐點編號</label>
                            <input readonly type="text" class="form-control" id="mealId" value="${mealVO.mealId}">
                        </div>
                        <div class="form-group row">
                            <label for="meal" class="fs-6 font-weight-bold">餐點</label>
                        ...
                        <div class="form-group row">
                            <label for="money" class="fs-6 font-weight-bold">金額</label>
                        ...
                        <input class="form-group  btn btn-danger btn-block fs-5 mt-10" type="submit" value="送出"
